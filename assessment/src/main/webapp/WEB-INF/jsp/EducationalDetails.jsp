				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="nav nav-tabs ml-auto">
							  <li class="nav-item">
							    <a class="nav-link" href="PersonalDetails"><strong>Personal Details</strong></a>
							  </li>
							  <li class="nav-item">
							    <a class="nav-link active" href="EducationalDetails"><strong>Educational Details</strong></a>
							  </li>
							</ul>
					</div>
				</div>
			...
			<div class="container main_body">
				<div class="row">
					...
					<div class=" side2 col-md-8 py-5 border">
						...
						<form action="EducationalDetails" method="post">
							<div class="form-row">
								<div class="form-group col-md-12 mb-2">
									<label id="X">Class Xth </label>
									<input id="X" name="Secondary" placeholder="Enter Marks(CGPA / %)"
										class="form-control" type="text"
										required >
								</div>
								<div class="form-group col-md-12 mb-2">
									<label id="XII">Class XIIth </label>
									<input type="text" class="form-control" id="XII"
							...
							<div class="form-row">
								<div class="form-group col-md-6 mb-2">
									...
									<input id="BTech" name="BTech" placeholder="Enter Marks(CGPA / %)"
										class="form-control" type="text"
										required >
								</div>
								<div class="form-group col-md-6 mb-2">
									<label id="MTech">MTech </label>
									<input type="text" class="form-control" id="MTech"
										placeholder="Enter Marks(CGPA / %)" type="text"
										>
								</div>
							</div>
							...
							<div class="form-row mb-2">
								...
								<div class="small text-muted mt-2">Upload your (Xth, XIIth or BTech/MTech) MarkSheet. Max
									file size 50 MB</div>
							</div>
	
							<div class="form-row">
								<input type="submit" value="Submit" class="btn login_btn" />
								<a href="EducationalDetailsEdit"  class="btn info_btn">Edit</a> 
							</div>
						</form>
					</div>
				</div>
