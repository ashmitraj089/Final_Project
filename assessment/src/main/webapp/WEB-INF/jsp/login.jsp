					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							<li class="nav-item active"><a class="nav-link"
								href="Register"><strong class="side_button">Sign Up</strong> <span class="sr-only">(current)</span></a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="user_card">
						...
						<div class="mt-4">
							<div class="d-flex justify-content-center links">
								Don't have an account? <a href="Register" class="ml-2">Sign
									Up</a>
							</div>
						</div>
					</div>
