...
<link rel="icon"
	...
	type="image/x-icon">
<style>
<%@ include file="PersonalDetails.css"%>
</style>
<link rel="stylesheet"
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="nav nav-tabs ml-auto">
							  <li class="nav-item">
							    <a class="nav-link active" href="PersonalDetails"><strong>Personal Details</strong></a>
							  </li>
							  <li class="nav-item">
							    <a class="nav-link" href="EducationalDetails"><strong>Educational Details</strong></a>
							  </li>
							</ul>
					</div>
				</div>
						...
						<form action="EducationalDetails" method="post">
							...
							<div class="form-row mb-2">
								<div class="input-group col-md-12 mb-2">
									...
									<textarea class="form-control form-control-lg" placeholder="Permanent Address" id="address"
							...
							<div class="form-row">
								...
								<a href="PersonalDetailsEdit"  class="btn info_btn">Edit</a> 
							</div>
						</form>
					</div>
				</div>
